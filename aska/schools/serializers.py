...
from schools.models import School, SchoolFeed, SchoolPicture
from schools.choices import SchoolOwner, SchoolType
from users.models import UserSchool
...
class SchoolSerializer(serializers.ModelSerializer):
    ...
    owner = serializers.ChoiceField(choices=SchoolOwner.choices)
