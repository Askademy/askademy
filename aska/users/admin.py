...
from users.models import CustomUser, UserSchool, Notification, PasswordResetRequest, Friendship
...
class CustomUserAdmin(UserAdmin):
    ...
    list_filter = ("gender", "birthdate", "date_joined", "is_active", "is_superuser", "is_staff")
    fieldsets = (
...
admin.site.register([Friendship, UserSchool, Notification])